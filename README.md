...
友達とリアルタイムで楽しめるマルチプレイヤー対応のゲームを2モード収録しています。

## 🎭 ゲーム選択フロー

1. **ゲームモード選択** - ワードウルフ🐺 / デマーシアに心を込めて💖
...
### 2. デマーシアに心を込めて 💖
「はぁというゲーム」のLOL/VALORANTバージョン！有名なセリフを、指定されたシチュエーションで演じ、他のプレイヤーに当ててもらうゲーム。
